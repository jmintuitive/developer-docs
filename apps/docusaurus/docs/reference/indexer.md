...
| collection_data_id_hash      | String | This is a hash identifying the data of the collection. Hashes must be exactly 66 characters, so may be 0 padded. Ex. "0xbd0818e81f08ccb0297a2ae80726e5f1a36ef077ad910d5c1efac79a824899f3" |
| collection_name              | String | The name of the collection to which the token belongs. Ex. "CryptoKitties" |
| creator_address              | String | This is an Aptos account address that created the token. Addresses must be 66 characters so may be 0 padded. Ex. "0x50bc83f01d48ab3b9c00048542332201ab9cbbea61bda5f48bf81dc506caa78a" |
...
| owner_address                | String | This is an Aptos account address that currently owns the token. Addresses must be 66 characters so may be 0 padded. Ex. "0xa815a9a09105973084bfc31530e7c8f002846787c2f0521e1e34dc144ad83b89" |
...
| token_data_id_hash           | String | This is a hash that uniquely identifies the token's data. Hashes must be exactly 66 characters, so may be 0 padded. Ex. "0xa815a9a09105973084bfc31530e7c8f002846787c2f0521e1e34dc144ad83b89" |
...
| collection_id                   | String | Identifier for the collection that includes this token. IDs must be exactly 66 characters, so may be 0 padded. Ex. "0x360f6eeabb4d7a9d2fab1f35b01e02831e3b5c4b73c7fd6c98dcc1c301c817c8" |
...
| owner_address                | String | This is an Aptos account address that currently owns the token. Addresses must be 66 characters so may be 0 padded. Ex. "0x123abc456def7890abcdef1234567890abcdef1234" |
...
| creator_address                      | String | This is an Aptos account address that created the asset. Addresses must be 66 characters so may be 0 padded. Ex. "0x50bc83f01d48ab3b9c00048542332201ab9cbbea61bda5f48bf81dc506caa78a" |
| decimals                             | bigint | Number of decimal places for token value, typically for fungible tokens. Ex. 18 |
...
| owner_address                   | String | This is an Aptos account address that owns the asset. Addresses must be 66 characters so may be 0 padded. Ex. "0x123abc456def7890abcdef1234567890abcdef1234" |
